...
} & { " $fragmentName"?: "OrderFragmentFragment" };
...
} & { " $fragmentName"?: "TableFragmentFragment" };

export type ReadOrderQueryVariables = Exact<{
  code: Scalars["String"]["input"];
}>;

export type ReadOrderQuery = {
  __typename?: "Query";
  readOrder?:
    | ({ __typename?: "Order" } & {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "extName" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "extSku" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "extUnitCost" },
                      },
                      {
                        kind: "Field",
...
export const TableFragmentFragmentDoc = {
  ...
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "TableFragment" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<TableFragmentFragment, unknown>;
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "ReadOrder" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<ReadOrderQuery, ReadOrderQueryVariables>;
export const ReadTableDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ReadTable" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<ReadTableQuery, ReadTableQueryVariables>;
